...
<head>
  ...
  <link rel="stylesheet" href="<?= base_url('assets/adminlte/plugins/incheck-bootstrap/incheck-bootstrap.min.css');?>">
  <link rel="stylesheet" href="<?= base_url('assets/adminlte/plugins/jqvmap/jqvmap.min.css');?>">
  <link rel="stylesheet" href="<?= base_url('assets/adminlte/plugins/overlayscrollbars/css/overlayscrollbars.min.css');?>">
  <link rel="stylesheet" href="<?= base_url('assets/adminlte/plugins/daterangkeppicker/daterangkeppicker.css');?>">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="../../CI_SIM23P/dosen" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Dosen</p>
                </a>
              </li>
